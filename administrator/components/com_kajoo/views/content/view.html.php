 ...
 * View to edit
 */
class KajooViewContent extends JViewLegacy
{
	protected $state;
	protected $item;
	protected $form;
	...
	public function display($tpl = null)
	{
		...
		$this->fields = $fieldsModel->getAllFields();
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_('COM_KAJOO_TITLE_CONTENT'), 'content.png');

		// If not checked out, can save the item.
		if (!$checkedOut && ($canDo->get('core.edit')||($canDo->get('core.create'))))
		{

			JToolBarHelper::apply('content.apply', 'JTOOLBAR_APPLY');
			JToolBarHelper::save('content.save', 'JTOOLBAR_SAVE');
		}
		...
		if (empty($this->item->id)) {
			...
			JToolBarHelper::cancel('content.cancel', 'JTOOLBAR_CLOSE');
		}
